    ...
    return (
        <div className="col-12 container-fluid">
            <div className="row">
                ...
                <div className="col-8 pt-1 pb-1 data">{totalDiscount }dh</div>
                <div className="col-4 pt-1 pb-1 title"><Lang>Total</Lang>(HT):</div>
                <div className="col-8 pt-1 pb-1 data">{ totalHT}dh</div>
                <div className="col-4 pt-1 pb-1 title"><Lang>Total Tax</Lang>:</div>
                <div className="col-8 pt-1 pb-1 data">{ totalTax}dh</div>
                <div className="col-4 pt-1 pb-1 title"><Lang>Total</Lang>(TTC):</div>
                <div className="col-8 pt-1 pb-1 data">{ totalTTC}dh</div>
                <div className="col-4 pt-1 pb-1 title"><Lang>The Rest</Lang>:</div>
                <div className="col-8 pt-1 pb-1 data">{rest}dh</div>
            </div>
        </div>
    )
}