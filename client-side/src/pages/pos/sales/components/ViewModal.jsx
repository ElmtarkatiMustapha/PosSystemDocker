...
export function ViewModal() {
    ...
    useEffect(() => {
        api({
            method: "get",
            url: "/saleForCashier/" + posState.salesContext?.currentItem,
                ...
                <form className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            ...
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.id}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Customer</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.customer?.name}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Adresse</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.customer?.adresse}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Phone</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.customer?.phone}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Sector</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.customer?.sector?.title}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Qnt</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.qnt}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Discount</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.discount.toFixed(2)}  id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Total</Lang>(HT) : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.total.toFixed(2)}  id="" />
                        </div>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Date</Lang> : {loading && <Spinner/>}</label>
                            <input type="text" required  disabled={true} name="title"  className="form-control"  defaultValue={order?.date}  id="" />
                        </div>
                        <DataTable
                            columns={columns}
