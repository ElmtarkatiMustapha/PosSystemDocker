...
export function EditModal() {
    ...
    useEffect(() => {
        api({
            method: "get",
            url: "/spent/" + spentsState.editItem,
                ...
                <form onSubmit={handleSubmit} className="modal-content">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="number" step={0.1}  disabled={loading} name="amount"  className="form-control" placeholder={Lang({ children: "Tap Amount" })} defaultValue={item?.amount} id="" />
                        </div>
                        <div className="mb-3">
                            <label className="form-label h5"><Lang>Description</Lang> : {loading && <Spinner/>}</label>
                            <textarea name="description" disabled={loading} className="form-control" placeholder={Lang({ children:"Tap description"})} defaultValue={item?.description}  id=""></textarea>
                        </div>
